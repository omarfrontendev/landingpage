    ...
    <header className={`${styles.header} d-flex align-items-center`}>
      <div className="container">
        <div className={`${styles.header__content} d-flex align-items-center justify-content-between`}>
          ...
          <ul className={`${styles.links__list} ${openMenu ? styles.opened : ''} d-flex align-items-center justify-content-end`}>
            ...
            <button className={`d-block d-md-none ${styles.close__btn}`} onClick={() => setOpenMenu(false)}><AiOutlineClose /></button>
          </ul>
          <button className={`d-block d-md-none ${styles.open__btn}`} onClick={() => setOpenMenu(true)}><AiOutlineMenu /></button>
        </div>
      </div>
    </header>
  )
