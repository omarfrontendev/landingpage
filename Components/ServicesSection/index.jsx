  ...
  useEffect(() => {
   ...
   const services = [
    ...
    },
    {
      ...
      desc: [
        `Need a new Logo? Want to revamp your LinkedIn banner? Need some new designs for your website?`,
        'We have 2 graphic designers on the team, both with different specialties and levels of experience. Portfolios available upon request.'
      ]
    },
    {
      id: 7,
      ...
      desc: [
        'Your LinkedIn coach told you to create more videos for your profile? Or maybe you want to explore generating an audience via TikTok?',
        'What you need is a video editor with a directing background, who is also able to create short films & edit them, or clean up an existing footage. Portfolio available upon request.'
      ]
    },
    {
      id: 8,
